...
use app\modules\siteadmin\models\ErrataSearch;
...
/**
 * ErrataController implements the CRUD actions for Errata model.
 */
class ErrataController extends Controller
{
 ...
 if($codunidade == 11){
    ...
    /**
     * Displays a single Errata model.
     * @param integer $id
 ...
 if($codunidade == 11){
    ...
    $session->close();
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            $model->file = UploadedFile::getInstance($model, 'file');
                ...
                if(empty($model->file)){
                Yii::$app->session->setFlash('danger', 'É obrigatório o envio do arquivo para inserir a Errata! ');
    ...
    /**
     * Updates an existing Errata model.
 ...
 if($codunidade == 11){
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            Yii::$app->session->setFlash('success', 'Errata atualizada com sucesso! ');
    ...
    /**
     * Deletes an existing Errata model.
    ...
    /**
     * Finds the Errata model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @param integer $edital_id
     * @return Errata the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Errata::findOne(['id' => $id])) !== null) {
            return $model;
        } else {
