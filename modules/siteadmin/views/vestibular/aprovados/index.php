...
/* @var $searchModel app\modules\siteadmin\models\vestibular\AprovadosSearch */
...
$this->title = 'Listagem de Aprovados';
...
<div class="aprovados-index">

    <h1><?= Html::encode($this->title) ?></h1>
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <p>
        <?= Html::a('Inserir Lista de Aprovados', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
    <?= GridView::widget([
