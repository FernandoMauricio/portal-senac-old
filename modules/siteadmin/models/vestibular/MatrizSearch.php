...
/**
 * MatrizSearch represents the model behind the search form about `app\modules\siteadmin\models\vestibular\Matriz`.
 */
class MatrizSearch extends Matriz
{
    ...
    public function rules()
    {
        return [
            ...
            [['nomeMatriz', 'arquivoMatriz', 'data'], 'safe'],
        ];
    }
    ...
    $session = Yii::$app->session;
        ...
        $query->andFilterWhere(['vestibular_id' => $session['sess_vestibular']])
            ->andFilterWhere(['like', 'nomeMatriz', $this->nomeMatriz])
            ->andFilterWhere(['like', 'arquivoMatriz', $this->arquivoMatriz]);
