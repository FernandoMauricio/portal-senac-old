...
use app\modules\comunicacaointerna\models\Unidade_uni;

/**
 * UnidadeUniSearch represents the model behind the search form about `app\modules\comunicacaointerna\models\Unidade_uni`.
 */
