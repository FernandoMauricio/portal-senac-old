...
use app\modules\comunicacaointerna\models\DespachocomunicacaoDeco;

/**
 * DespachocomunicacaoDecoSearch represents the model behind the search form about `app\modules\comunicacaointerna\models\DespachocomunicacaoDeco`.
 */
