...
use app\modules\manut_transporte\models\ManutencaoAdminAcompanhamento;

/**
 * ManutencaoAdminAcompanhamentoSearch represents the model behind the search form about `app\modules\manut_transporte\models\ManutencaoAdminAcompanhamento`.
 */
