...
<div class="planilha-justificativas-index">
    ...
    <p>
        <?= Html::button('Inserir Justificativa', ['value'=> Url::to('index.php?r=aux_planejamento/planilhas/planilha-justificativas/create'), 'class' => 'btn btn-success', 'id'=>'modalButton']) ?>
    </p>
