...
?>
    ...
    <p>
        ...
        <?= Html::button('Enviar Planejamento', ['value'=> Url::to('index.php?r=aux_planejamento/planilhas/planilhadecurso/enviar-planejamento'), 'class' => 'btn btn-warning pull-right', 'id'=>'modalButton']) ?>
    </p>
