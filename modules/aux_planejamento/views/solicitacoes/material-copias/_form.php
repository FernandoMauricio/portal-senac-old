...
/* @var $model app\modules\aux_planejamento\models\solicitacoes\MaterialCopias */
...
<div class="row">
    ...
    <div class="col-md-3">
        ...
        <?php
        $segmentoList=ArrayHelper::map(app\modules\aux_planejamento\models\cadastros\Segmento::find()->all(), 'seg_codsegmento', 'seg_descricao' );
          ...
          <?php
              ...
              echo $form->field($model, 'matc_curso')->widget(DepDrop::classname(), [
                  ...
                  'pluginOptions'=>[
                      ...
                      //'initialize' => true,
                      'url'=>Url::to(['/aux_planejamento/solicitacoes/material-copias/cursos'])
                  ]
              ]);
          ?>
    </div>
          ...
          <?php
              ...
              echo $form->field($model, 'matc_centrocusto')->widget(DepDrop::classname(), [
                  ...
                  'pluginOptions'=>[
                      ...
                      //'initialize' => true,
                      'url'=>Url::to(['/aux_planejamento/solicitacoes/material-copias/centrocusto'])
                  ]
              ]);
          ?>
    </div>
