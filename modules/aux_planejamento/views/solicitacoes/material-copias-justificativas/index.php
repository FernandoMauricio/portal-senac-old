...
/* @var $searchModel app\modules\aux_planejamento\models\solicitacoes\MaterialCopiasJustificativasSearch */
...
<div class="material-copias-justificativas-index">
    ...
    <p>
        <?= Html::button('Inserir Justificativa', ['value'=> Url::to('index.php?r=aux_planejamento/solicitacoes/material-copias-justificativas/create'), 'class' => 'btn btn-success', 'id'=>'modalButton']) ?>
    </p>
